 ...
 */
  ...
  */
  Handlebars.registerHelper('note', function (index, options) {
    ...
    * @example
    * // returns <sup><a href="#note-1" id="note-1-ref" class="note">*</a></sup>
    * Handlebars.helpers.note(1);
    * @example
    * // returns <sup><a href="#note-2" id="note-2-ref" class="note">**</a></sup>
    ...
    */
    ...
    html.push('<sup>');
    html.push('<a href="#note-' + index + '" id="note-' + index + '-ref" class="note">');
